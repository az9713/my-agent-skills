...
Five personal skills for [Claude Code](https://claude.com/claude-code), plus an example audit report showing the skill-best-practices auditor in action.
...
cp -r .claude/skills/mcp-doctor ~/.claude/skills/
```
